...
<body>
	...
	<br />
	<form method="post" action="${pageContext.request.contextPath}/usermertwo">
		...
		<table>
			...
			<tr>
				<td class="label">Generated Number </td>
				<td><input class="control"  name="otp"
						type="text"   id="otp"/><br /></td>
			</tr>
